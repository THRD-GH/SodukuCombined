...
const SECTIONS: [string, string[]][] = [
  ...
  [
    ...
    [
      ...
      'Settings offers a background behind every screen: dojo-themed patterns, or a photo of your own, which stays on your device, with a dim slider to keep it quiet.',
    ],
  ],
  [
    'Keyboard',
